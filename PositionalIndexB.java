...
public class PositionalIndexB {
   ...
   //constructor
   public PositionalIndexB(String[] docs) {
      //#3
      myDocs = docs;
      ...
      for(int i=0;i<myDocs.length;i++) {
         ...
         for(int j=0;j<words.length;j++) {
            ...
            if(!termList.contains(word)) {
               ...
               docList = docLists.get(index);//fetch the doclist containing the word
               ...
               if(!match) {         //add to doc list if exist
                  Doc doc = new Doc(i,j);
                  docList.add(doc);
               }
            }
   ...
   public static void main(String[] args) {
      ...
      PositionalIndexB pi = new PositionalIndexB(docs);
